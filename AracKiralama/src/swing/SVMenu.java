 ...
 * @author sudeg
 */
public class SVMenu extends javax.swing.JPanel {

    public void setShowing(boolean showing) {
        this.showing = showing;
    }

    public ArrayList<SVMenu> getSubMenu() {
        return subMenu;
    }
     ...
     */
    private final ArrayList<SVMenu> subMenu = new ArrayList<>();
    private ActionListener act;
    
    public SVMenu(Icon icon, String menuName, ActionListener act, SVMenu... subMenu) {
        initComponents();
        lbIcon.setIcon(icon);
        ...
        for (int i = 0; i < subMenu.length; i++) {
            ...
            subMenu[i].setBackground(java.awt.Color.WHITE);
        }
    }
