 ...
 * @author sudeg
 */
public class SVGiris extends javax.swing.JFrame{
    ...
    private void execute(){
        ...
        ImageIcon iconPersonel = new ImageIcon(getClass().getResource("/icon/icons8_staff_30px.png"));
        ...
        SVMenu kul_islemleri = new SVMenu(iconPersonel, "PERSONEL İŞLEMLERİ", new ActionListener() {
            
            
            @Override
            public void actionPerformed(ActionEvent ae) {
                
                jLabel2.setText("Personel İşlemleri");
                
                panel_sag1.removeAll();
                panel_sag1.add(new Personel_islemleri());
        ...
        addMenu(musteriİslemleri,aracListeleme,menuAracİslemleri,fatura,tahsilatİslemleri,odemeİslemleri,kul_islemleri,cikis);
